...
DRF_AUTO_BASE_VIEWSET = '{{ cookiecutter.repo_name }}.views.ModelViewSet'
DRF_AUTO_BASE_READONLY_VIEWSET = '{{ cookiecutter.repo_name }}.views.ReadOnlyModelViewSet'
...
EXPORTER_ROUTER_PATH = '{{ cookiecutter.repo_name }}.api_urls.router'
EXPORTER_FRONT_APPLICATION_NAME = '{{ cookiecutter.module_prefix }}'
